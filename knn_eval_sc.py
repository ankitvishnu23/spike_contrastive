...
data_path='/home/gridsan/evanv/charlotte/spike_data/single_dy016_random_neurons_05_16_2023'
...
# ckpt_path = '/home/gridsan/evanv/charlotte/spike_contrastive/runs/0509out_dim512proj_dim5batch-size512lr0.001epochs800fp16use_gptis_causaln_embd32add_traindropout0.0/checkpoint.pth'
ckpt_path = '/home/gridsan/evanv/charlotte/spike_contrastive/runs/0513dataout_dim128proj_dim5batch-size512lr0.001epochs800fp16use_gptis_causaln_embd32add_traindropout0.0/checkpoint.pth'
...
save_reps(model.cuda(), test_loader, ckpt_path, split='test', multi_chan=False, rep_after_proj=True, use_chan_pos=False, suffix='_data0516')

# save_reps(model2.cuda(), train_loader, multi_ckpt_path, split='train', multi_chan=True, rep_after_proj=False, use_chan_pos=True)

# save_reps(model.cuda(), train_loader, ckpt_path, split='train', multi_chan=False, rep_after_proj=True, use_chan_pos=False, suffix='_data0516')
