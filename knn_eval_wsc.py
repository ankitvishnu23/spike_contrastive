...
multi_data_path='/gpfs/wscgpfs02/shivsr/cloh/spike_data/multi_dy016_random_neurons_05_13_2023'
...
# multi_ckpt_path = '/gpfs/wscgpfs02/shivsr/cloh/spike_contrastive/saved_models/0510_mc_conseq_causal_n64_b1331_bs120_extra5_lr0.0005_poschan_half_embed/checkpoint.pth'
multi_ckpt_path = '/gpfs/wscgpfs02/shivsr/cloh/spike_contrastive/saved_models/0510_mc_conseq_causal_n64_b1331_bs120_extra5_lr0.0005_poschan_mergelayer_layernorm/checkpoint.pth'
model = load_ckpt(multi_ckpt_path, multi_chan = True, rep_after_proj=True, use_chan_pos=True, use_merge_layer=True, add_layernorm=True, half_embed_each=False)
model2 = load_ckpt(multi_ckpt_path, multi_chan = True, rep_after_proj=False, use_chan_pos=True, use_merge_layer=True, add_layernorm=True, half_embed_each=False)
