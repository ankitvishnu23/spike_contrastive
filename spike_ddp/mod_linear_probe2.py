...
def main_worker(gpu, args):
    ...
    model.fc = get_classifier(rep_dim=2048,bayes=args.bayes,bayes_mode='reparam',ensem=False,mlp_depth=args.mlp_depth, mlp_hidden_dim=args.mlp_hidden_dim,\
                        prior_mu=args.prior_mu,prior_sigma=args.prior_sigma,prior_sigma1=1.,prior_sigma2=0.01,prior_pi=0.5,\
                        ensem_samples=1, mimo=False, add_bn=False).cuda(gpu)
