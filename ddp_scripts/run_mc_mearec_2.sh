...
python \
      ...
      --data $HOME2/scratch/spike_data/multi_mearec_random_neurons_05_14_2023 \
      --workers 32 \
      --epochs 800 \
      --batch-size 128 \
      --out_dim 5 \
      ...
      --ngpus-per-node 4 \
      --nodes 4 \
      --exp 0514_mearec_outdim5proj5_mc_gpt_conseq_causal_nembd64_block1331_bs128_extra5_lr${lr}_knn10_addtrain_2 \
      --block_size 1331 \
      --n_embd 64 \
      --multi_chan \
      --pos_enc conseq \
